       ...
       <div className="space-y-3">
           {filteredList.map(s => {
               ...
               <React.Fragment key={s.id}>
                   {showHeader && <h3 className={`text-xs font-bold text-gray-500 uppercase mt-6 mb-2 pl-1 border-b border-gray-200 pb-1 ${opacityClass}`}>{dateStr} {s.date === today && <span className="text-blue-600 ml-2">(HOY)</span>}</h3>}
